...
tcpdump_p = start_dump_pcap(SERVER_IP, client_port, "BAD_SEQNUM_FIN")
...
fin_pkt = IP(dst=SERVER_IP)/TCP(sport=client_port, dport=SERVER_PORT, flags='F', seq=client_ISN - 12345)
send(fin_pkt)
