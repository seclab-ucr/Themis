...
tcpdump_p = start_dump_pcap(SERVER_IP, client_port, "MULTIPLE_SYN")
...
syn_pkt = IP(dst=SERVER_IP)/TCP(sport=client_port, dport=SERVER_PORT, flags='S', seq=client_ISN - 12345)
send(syn_pkt)
