...
tcpdump_p = start_dump_pcap(SERVER_IP, client_port, "SYN_DATA2")
...
syn_pkt = IP(dst=SERVER_IP)/TCP(sport=client_port, dport=SERVER_PORT, flags='S', seq=client_ISN)/Raw(load=DUMMY_REQ)
send(syn_pkt)
