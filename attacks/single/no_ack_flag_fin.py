...
tcpdump_p = start_dump_pcap(SERVER_IP, client_port, "NO_ACK_FLAG_FIN")
...
fin_pkt = IP(dst=SERVER_IP)/TCP(sport=client_port, dport=SERVER_PORT, flags='F', seq=client_ISN + 21)
#rst_pkt.show()
send(fin_pkt)
