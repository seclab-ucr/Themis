...
tcpdump_p = start_dump_pcap(SERVER_IP, client_port, "PARTIAL_IN_WINDOW_RST")
...
rst_pkt = IP(dst=SERVER_IP)/TCP(sport=client_port, dport=SERVER_PORT, flags='R', seq=client_ISN + 1)/Raw(load='A' * 30)
send(rst_pkt)
