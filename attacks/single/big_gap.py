...
tcpdump_p = start_dump_pcap(SERVER_IP, client_port, "BIG_GAP")
...
req_pkt = IP(dst=SERVER_IP)/TCP(sport=client_port, dport=SERVER_PORT, flags='A', seq=client_ISN + 100000, ack=server_ISN + 1)/Raw(load='A' * 20)
send(req_pkt)
