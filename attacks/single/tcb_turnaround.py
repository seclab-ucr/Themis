...
tcpdump_p = start_dump_pcap(SERVER_IP, client_port, "TCB_TURNAROUND")

synack_pkt = IP(dst=SERVER_IP)/TCP(sport=client_port, dport=SERVER_PORT, flags='SA', seq=client_ISN)
send(synack_pkt)
