...
tcpdump_p = start_dump_pcap(SERVER_IP, client_port, "BAD_SEQNUM_RST")
...
rst_pkt = IP(dst=SERVER_IP)/TCP(sport=client_port, dport=SERVER_PORT, flags='R', seq=client_ISN - 12345)
send(rst_pkt)
