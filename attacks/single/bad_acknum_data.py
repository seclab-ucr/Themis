...
tcpdump_p = start_dump_pcap(SERVER_IP, client_port, "BAD_ACKNUM_DATA")
...
req_pkt = IP(dst=SERVER_IP)/TCP(sport=client_port, dport=SERVER_PORT, flags='A', seq=client_ISN + 1, ack=server_ISN - 12345678)/Raw(load=DUMMY_REQ)
send(req_pkt)
