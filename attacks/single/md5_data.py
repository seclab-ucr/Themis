...
tcpdump_p = start_dump_pcap(SERVER_IP, client_port, "MD5_DATA")
...
req_pkt = IP(dst=SERVER_IP)/TCP(sport=client_port, dport=SERVER_PORT, flags='A', seq=client_ISN + 1, ack=server_ISN + 1, options=[(19, b'\x11\x22\x33\x44\x55\x66\x77\x88\x99\x00\x11\x22\x33\x44\x55\x66'), ('NOP', 0), ('NOP', 0)])/Raw(load=DUMMY_REQ)
send(req_pkt)
