...
tcpdump_p = start_dump_pcap(SERVER_IP, client_port, "IN_WINDOW_FIN")
...
fin_pkt = IP(dst=SERVER_IP)/TCP(sport=client_port, dport=SERVER_PORT, flags='FA', seq=client_ISN + 22, ack=server_ISN + 1)
send(fin_pkt)
